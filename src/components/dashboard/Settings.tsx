    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="space-y-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-gray-300 font-medium">{maxApplicationsPerWeek[0]}</span>
                </div>
                <Slider
              ...
              <div className="space-y-3">
                <div className="p-4 bg-gray-800 rounded-lg">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-300 font-bold">${estimatedWeeklyCost.toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                ...
                <Select value={cvLength} onValueChange={setCvLength}>
                  ...
                  <SelectContent>
                    <SelectItem value="1" className="text-white hover:bg-gray-700">1 Page</SelectItem>
                    <SelectItem value="2" className="text-white hover:bg-gray-700">2 Pages</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {alwaysInclude.map((asset) => (
                    <Badge key={asset} variant="default" className="flex items-center gap-1 bg-gray-600">
                      {asset}
                      <button
                ...
                <Select>
                  ...
                  <SelectContent>
                    {availableAssets
                      ...
                      .map((asset) => (
                        <SelectItem key={asset} value={asset} className="text-white hover:bg-gray-700">
                          {asset}
                        </SelectItem>
                      ))}
                  </SelectContent>
        ...
        <div className="flex justify-end">
          <Button onClick={handleSaveSettings} className="bg-gray-700 hover:bg-gray-600 border border-gray-600">
            Save Configuration
          </Button>
        </div>
      </div>
