/**
 * OpenAI Job Discovery Service - Frontend integration for OpenAI-powered job search
 */
...
export class OpenAIJobDiscoveryService {
  private baseUrl: string;

  constructor(baseUrl: string = '/api/openai') {
...
export const openaiJobDiscoveryService = new OpenAIJobDiscoveryService();